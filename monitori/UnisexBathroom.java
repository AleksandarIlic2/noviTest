class SingleBathroomProblem {
    ...
    private void signalPersonOrChild() {
        boolean personWaiting = queue.queue() && queue.minrank() % 3 == group; // ovo proverava dal je prvi u redu cekanja istog tipa kao onaj sto je izasao iz wca (vrv je ideja da ima jos tog tipa ljudi u wc)
        boolean childWaiting = childrenQueue.queue(); // ovo proverava da li ima dece
